...
#
# from page_model.homepage import LoginPage
...
#     WebDriverWait(context.driver, 10).until(expected_conditions.visibility_of(LoginPage.app_name(context)))
#
# @when("The user closes the welcome message")
# def step_impl(context):
#     WebDriverWait(context.driver, 10).until(expected_conditions.visibility_of(CommonLocators.WELCOME_MSG)).click()
#
# @step("The user lands on the homepage")
# def step_impl(context):
#     # WebDriverWait(context.driver, 10).until_not(expected_conditions.visibility_of(CommonLocators.WELCOME_MSG))
#     sleep(1)
